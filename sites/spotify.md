...
Reference source: `https://www.spotify.com/us/premium/`
...
- Page archetype: **subscription landing**.
...
| 3 | `offer_stack` | Convert attention into subscription understanding. |
...
| `offer_stack` | Offer heading, short value sentence, plan or catalog proof. | Replace all catalog, plan, and availability details with owned facts. |
...
| CTA candidates measured | 8 |
| Link labels measured | 16 |
| Heading word target | 8.6 |
| Paragraph word target | 8.0 |
| CTA word target | 3.0 |
