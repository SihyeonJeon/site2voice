...
Reference source: `https://github.com/`
...
- Page archetype: **technical product landing**.
...
| 3 | `capability_stack` | Move from outcome to workflow, proof, and implementation detail. |
...
| `capability_stack` | Outcome heading, concrete capability sentence, concise action link. | Explain the new product's actual mechanics; do not borrow platform claims. |
...
| CTA candidates measured | 12 |
| Link labels measured | 16 |
| Heading word target | 5.3 |
| Paragraph word target | 12.4 |
| CTA word target | 2.8 |
