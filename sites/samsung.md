...
Reference source: `https://www.samsung.com/`
...
- Page archetype: **product landing**.
...
| 3 | `core_value_sections` | Explain the product through repeated value, proof, and action blocks. |
...
| `core_value_sections` | Specific heading, short proof sentence, compact CTA. | Keep each section tied to a real product capability. |
...
| CTA candidates measured | 2 |
| Link labels measured | 16 |
| Heading word target | 3.2 |
| Paragraph word target | 8.4 |
| CTA word target | 1.5 |
