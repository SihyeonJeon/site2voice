...
- Sentence shape: about **8.4 words** per sentence.
...
- Keep average sentence length between **6.3 and 10.5 words**.
- Keep headings near **4.9 words**; avoid generic one-word section labels unless the source uses them.
- Keep paragraph blocks near **9.0 words**.
- Keep CTAs near **2.2 words** and start them with: `sign`, `get`, `learn`, `contact`.
...
- If writing a candidate file, run:
  `site2voice bench https://www.netflix.com/ path/to/candidate.md --strict`
