...
- Overall tone: **balanced, trust-forward**.
- Sentence shape: about **10.8 words** per sentence.
...
- Heading shape: about **6.8 words** per heading.
- Paragraph rhythm: about **8.9 words** per paragraph sample.
- CTA shape: about **1.7 words** per CTA.
- CTA verbs: `download`, `learn`, `contact`.
- Navigation label shape: about **1.4 words** per label.
- Lexical variety: **0.31** type-token ratio.
...
- Keep average sentence length between **8.1 and 13.5 words**.
- Keep headings near **6.8 words**; avoid generic one-word section labels unless the source uses them.
- Keep paragraph blocks near **8.9 words**.
- Keep CTAs near **1.7 words** and start them with: `download`, `learn`, `contact`.
...
- If writing a candidate file, run:
  `site2voice bench https://www.whatsapp.com/ path/to/candidate.md --strict`
