...
Reference source: `https://www.zillow.com/mortgages/`
...
- Page archetype: **marketplace landing**.
...
| 3 | `decision_path` | Help the reader compare, trust, and choose the next action. |
...
| `decision_path` | Benefit-led heading, practical constraint, short action. | Use only the new offer, price, availability, and trust claims. |
