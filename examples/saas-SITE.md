...
- Page archetype: **conversion landing**.
...
| 5 | `conversion_band` | Repeat the next action after value and proof are established. |
...
| Link labels measured | 7 |
| Heading word target | 5.8 |
| Paragraph word target | 16.5 |
| CTA word target | 2.2 |
