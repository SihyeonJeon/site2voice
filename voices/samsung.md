...
- Heading shape: about **3.2 words** per heading.
- Paragraph rhythm: about **8.4 words** per paragraph sample.
- CTA shape: about **1.5 words** per CTA.
- CTA verbs: `보기`, `확인`.
- Navigation label shape: about **1.4 words** per label.
- Lexical variety: **0.272** type-token ratio.
...
- Keep headings near **3.2 words**; avoid generic one-word section labels unless the source uses them.
- Keep paragraph blocks near **8.4 words**.
- Keep CTAs near **1.5 words** and start them with: `보기`, `확인`.
...
- If writing a candidate file, run:
  `site2voice bench https://www.samsung.com/ path/to/candidate.md --strict`
