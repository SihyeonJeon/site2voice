...
- Sentence shape: about **6 words** per sentence.
...
- Heading shape: about **2.2 words** per heading.
- Paragraph rhythm: about **5.8 words** per paragraph sample.
- CTA shape: about **2.3 words** per CTA.
- CTA verbs: `contact`, `demo`, `create`, `learn`.
- Navigation label shape: about **1.4 words** per label.
- Lexical variety: **0.259** type-token ratio.
...
- Keep average sentence length between **4.5 and 7.5 words**.
- Keep headings near **2.2 words**; avoid generic one-word section labels unless the source uses them.
- Keep paragraph blocks near **5.8 words**.
- Keep CTAs near **2.3 words** and start them with: `contact`, `demo`, `create`, `learn`.
...
- If writing a candidate file, run:
  `site2voice bench https://www.canva.com/about/ path/to/candidate.md --strict`
