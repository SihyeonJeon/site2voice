...
- CTA verbs: `see`, `request`, `get`, `read`, `explore`.
...
- Benchmark drift check: keep average sentence length between **4.0 and 6.1 words**.
...
- Keep CTAs near **3.2 words** and start them with: `see`, `request`, `get`, `read`, `explore`.
